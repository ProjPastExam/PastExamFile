...
function sc_banditBoss01Atk01(){
	...
	else if ( process < 36 )	{ image_index = 4; xSpeed = dir*30; }
	else if ( process < 51 )	{ image_index = 5; }
	else if ( process < 57 )	{ image_index = 6; }
	else if ( process < 63 )	{ image_index = 6; xSpeed = dir*30; }
	else if ( process < 78 )	{ image_index = 7; }
	else if ( process < 84 )	{ image_index = 0; }
	//else if ( process < 86 )	{ image_index = 1; }
	else if ( process < 102 )	{ image_index = 4; }
	else if ( process < 108 )	{ image_index = 4; xSpeed = dir*50; }
