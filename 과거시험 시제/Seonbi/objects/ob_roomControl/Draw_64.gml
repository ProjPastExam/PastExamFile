...
if (isTalk == 1 || isTalk == 2 || isTalk == 5) {
	...
	draw_sprite(sp_talkMul, talkZ, talkX, talkY+_mobile_index);
}
else if (isTalk == 7) {
	draw_sprite(sp_talkNug, talkZ, talkX, talkY+_mobile_index);
}
else if (isTalk == 8) {
	draw_sprite(sp_talk2, talkZ, talkX, talkY+_mobile_index);
}
