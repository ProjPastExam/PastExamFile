...
function sc_jpBossatk(){
	...
	if ( state == 10 ) {
		...
		else if ( process < 80+lvDly ) { image_index = 4; }
		else if ( process < 85+lvDly ) { image_index = 5; xSpeed = dir*25; }
		else if ( process < 95+lvDly ) { image_index = 6; xSpeed = dir*25; }
		else if ( process < 105+lvDly ) { image_index = 7; }
		else if ( process < 110+lvDly ) { image_index = 8; }
		else if ( process < 125+lvDly ) { image_index = 9; }
		else { sc_jpBossAtkNext(80);	delay = 45+lvDly;	process = 0; isCounter = false; }
	}
		...
		else { sc_jpBossAtkNext(nextState);	process = 0;	delay = 50+lvDly*2; }
	}
		...
		else { sc_jpBossAtkNext(nextState); state = 9;	process = 80;	delay = 40+lvDly*2 + phaseDelay*4; }
		...
		else { sc_jpBossAtkNext(nextState);	process = 0;	delay = 65+lvDly*2 + phaseDelay*2; }
		...
		else { sc_jpBossAtkNext(nextState);	process = 0;	delay = 80+lvDly*2; }
	}
...
function sc_jpBossAtkNext(index = state){
	...
	if (index == 80) {
		...
		if (ran < 6) { nextState = 12; process = 0; }
		else { nextState = 18; process = 0; }
	}
	else if (index == 22) {
