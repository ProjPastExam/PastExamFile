...
function sc_pl_atkFront(){
	...
	*/
	if ( atkProcess > 10 && atkProcess < 34 ) {
		if (keyAttack) {
			if ( keyDown ) 		nextAtk = 5;
			else if ( keyTop ) 	nextAtk = 6;
			else if ( (dir == -1 && keyRight) || (dir == 1 && keyLeft) )	nextAtk = 4;
	...
	if ( atkProcess < 6 )		{ image_index = 0; nextAtk = 0; xSpeed = 15*dir; }
	else if ( atkProcess < 9 )	{ image_index = 1; xSpeed = 10*dir; }
	else if ( atkProcess < 12 )	{ image_index = 2; xSpeed = 5*dir; }
	else if ( atkProcess < 15 )	{ image_index = 3; xSpeed = 8*dir;}
	else if ( atkProcess < 19 )	{ image_index = 4; xSpeed = 14*dir; }
	else if ( atkProcess < 24 )	{ image_index = 5; xSpeed = 12*dir; }
	else if ( atkProcess < 30 )	{ image_index = 6; xSpeed = 8*dir; }
	else if ( atkProcess < 34 )	{ image_index = 7; xSpeed = 4*dir; 
	...
	else if ( atkProcess < 37 )	{ image_index = 8; nextAtk = 0}
	else if ( atkProcess < 44 )	{ image_index = 9; xSpeed = 15*dir; }
	else if ( atkProcess < 48 )	{ image_index = 9; xSpeed = 10*dir; }
	else if ( atkProcess < 53 )	{ image_index = 9; xSpeed = 5*dir; }
