...
function sc_pl_atkFront(){
	...
	if ( atkProcess > 20 && atkProcess < 45 ) {
		if (keyAttack) {
			if ( keyDown ) 		nextAtk = 5;
			else if ( keyTop ) 	nextAtk = 6;
			else if ( (dir == -1 && keyRight) || (dir == 1 && keyLeft) )	nextAtk = 4;
	...
	else if ( atkProcess < 16 )	{ image_index = 2; xSpeed = 5*dir; }
	...
	else if ( atkProcess < 24 )	{ image_index = 3; nextAtk = 0; xSpeed = 8*dir; nextAtk = 0;}
	else if ( atkProcess < 27 )	{ image_index = 4; xSpeed = 15*dir; }
	else if ( atkProcess < 32 )	{ image_index = 5; xSpeed = 12*dir; }
	else if ( atkProcess < 38 )	{ image_index = 6; xSpeed = 8*dir; }
	else if ( atkProcess < 42 )	{ image_index = 7; xSpeed = 6*dir; 
		if (nextAtk == 5)	{ canMove = 5;	atkProcess = 0; }
		if (nextAtk == 6)	{ canMove = 6;	atkProcess = 0; }
		if (nextAtk == 4)	{ canMove = 4;	atkProcess = 0; }
		if ( nextAtk == -1 && global.mp >= skMp[global.sk1]) 
	...
	else if ( atkProcess < 52 )	{ image_index = 9; xSpeed = 15*dir; }
	else if ( atkProcess < 56 )	{ image_index = 9; xSpeed = 10*dir; }
	else if ( atkProcess < 61 )	{ image_index = 9; xSpeed = 5*dir; }
	else if ( atkProcess < 68 ) {
