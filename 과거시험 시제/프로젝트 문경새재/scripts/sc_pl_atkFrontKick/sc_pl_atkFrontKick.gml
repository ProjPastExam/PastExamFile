...
function sc_pl_atkFrontKick(){
	...
	if ( (atkProcess > 15 && atkProcess < 40) || (atkProcess > 40 ) ) {
		if (keyAttack) {
	...
	else if ( atkProcess < 24 )	{ image_index = 4; }
	else if ( atkProcess < 28 )	{ image_index = 5; }
	...
	else if ( atkProcess < 48 )	{ image_index = 7; xSpeed = 16*dir; }
	else if ( atkProcess < 52 )	{ image_index = 8; xSpeed = 13*dir; }
	else if ( atkProcess < 56 )	{ image_index = 9; xSpeed = 10*dir; }
	else if ( atkProcess < 60 )	{ image_index = 10; xSpeed = 6*dir; }
	else { 
		{ canMove = 2;	atkProcess = 12; }
		if (nextAtk == 4)	{ canMove = 4;	atkProcess = 0; }
		if (nextAtk == 5)	{ canMove = 5;	atkProcess = 0; }
		if (nextAtk == 6)	{ canMove = 6;	atkProcess = 0; }
