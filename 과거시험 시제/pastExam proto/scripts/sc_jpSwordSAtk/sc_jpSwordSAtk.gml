...
function sc_jpSwordSAtk(){
	...
	if ( state == 10 ) {
		...
		else if ( process < 14 ) { image_index = 1; xSpeed = dir*15; }
		else if ( process < 18 ) { image_index = 1; xSpeed = dir*20; }
		else if ( process < 22 ) { image_index = 1; xSpeed = dir*24; }
		else if ( process < 27 ) { image_index = 2; }
