...
function sc_jpSwordSAtk(){
	...
	if ( state == 10 ) {
		...
		else if ( process < 34 ) { image_index = 1; xSpeed = dir*15; }
		else if ( process < 38 ) { image_index = 1; xSpeed = dir*20; }
		else if ( process < 42 ) { image_index = 1; xSpeed = dir*24; }
		else if ( process < 47 ) { image_index = 2; }
