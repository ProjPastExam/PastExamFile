...
function sc_pl_atk2(){
	...
	if ( atkProcess < 6 )		{ image_index = 0; nextAtk = 0; if (isJump) { ySpeed = -1; } }
	else if ( atkProcess < 15 )	{ image_index = 1; if (isJump) { ySpeed = -2; } }
	else if ( atkProcess < 24 )	{ image_index = 2; if (isJump) { ySpeed = -1; } }
