...
function sc_bandit03Atk(){
	...
	if ( state == 10 ) {
		...
		else if ( process < 67 ) { image_index = 3; xSpeed = dir*18; }
		else if ( process < 73 ) { image_index = 4; xSpeed = dir*21; }
		else if ( process < 77 ) { image_index = 4; xSpeed = dir*24; }
		else if ( process < 81 ) { image_index = 5; }
		else if ( process < 87 ) { image_index = 6; }
