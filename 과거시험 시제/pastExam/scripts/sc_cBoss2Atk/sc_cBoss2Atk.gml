...
function sc_cBoss2Atk(){
	...
	if ( state == 10 ) {
		...
		else if ( process < 80+lvDly ) { image_index = 3; xSpeed = dir*20; }
		else if ( process < 96+lvDly ) { image_index = 4; }
		else if ( process < 102+lvDly ) { image_index = 5; }
		else if ( process < 122+lvDly ) { image_index = 6; xSpeed = dir*20; }
		else if ( process < 128+lvDly ) { image_index = 7; }
		else if ( process < 134+lvDly ) { image_index = 8; }
		else if ( process < 140+lvDly ) { image_index = 9; }
		else if ( process < 160+lvDly ) { image_index = 10; }
		else if ( process < 180+lvDly ) { image_index = 11; xSpeed = dir*30; }
		else if ( process < 190+lvDly ) { image_index = 12; }
		else if ( process < 210+lvDly ) { image_index = 13; }
