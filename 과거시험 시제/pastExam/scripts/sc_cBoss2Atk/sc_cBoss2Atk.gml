...
function sc_cBoss2Atk(){
	...
	if ( state == 10 ) {
		...
		else { state = 10;	delay = 70;	process = 0;	isCounter = false; }
	}
	else if ( state == 15 ) {
		process++;
		sprite_index = sp_cB2_atk3;
		xSpeed = 0;
		isDK = true;
		isCounter = true;
		...
		else if ( process < 56 ) { image_index = 5; }
		else if ( process < 64 ) { image_index = 6; }
		else if ( process < 72 ) { image_index = 7; }
