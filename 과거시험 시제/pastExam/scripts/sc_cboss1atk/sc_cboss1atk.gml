...
function sc_cBoss1Atk(){
	...
	if ( state == 10 ) {
		...
		else if ( process < 84+lvDly ) { image_index = 6; xSpeed = dir*30; }
		...
		if ( process == 30+lvDly ) { SE_Play(s_cB1_atk2_2, global.vol); }
		if ( process == 60+lvDly ) { 
		...
		else if ( process < 36+lvDly ) { image_index = 3;	ySpeed = -12; }
		else if ( process < 42+lvDly ) { image_index = 4;	ySpeed = -8; }
		else if ( process < 60+lvDly ) { image_index = 5;	ySpeed = -2; }
		else if ( process < 84+lvDly ) { image_index = 6; xSpeed = dir*30;	ySpeed = 0; }
		...
		if ( process < 6 ) { image_index = 0; }
		else if ( process < 23+lvDly ) { image_index = 1; }
		else if ( process < 29+lvDly ) { image_index = 2; }
		else if ( process < 35+lvDly ) { image_index = 3; }
		else if ( process < 41+lvDly ) { image_index = 4; }
		else if ( process < 58+lvDly ) { image_index = 5; }
		else if ( process < 70+lvDly ) { image_index = 5; xSpeed = dir*20; }
		...
		else if ( process < 58+lvDly ) { image_index = 3; }
		else if ( process < 66+lvDly ) { image_index = 4; }
