...
function sc_npc_ranSunbi(){
	...
	var dIndex = true;
	if (ranIndex < 50) dIndex = false;
	
	if (dIndex && ranStage1 == 0) {
		ranStage1 = irandom_range(1, 3);
		//ranStage1 = 1;
	}
	if (!dIndex && ranStage2 == 0) {
	...
	if (global.lan == 0) {
		...
		if (ranStage1 == 1) {
			talkq1[@0]	= new talkStruct("이런, 흉조로군... \n적들은 강인한 체력으로 그대의 앞길을 가로막소. \n[적들의 체력이 1.5배 증가합니다.]",);
		}
		else if (ranStage1 == 2) {
			talkq1[@0]	= new talkStruct("여행길에 흉조가 드리우는군... \n적들의 맹렬한 공격을 조심하시오. \n[적들의 공격력이 강해집니다.]");
		}
		else if (ranStage1 == 3) {
			talkq1[@0]	= new talkStruct("흉조를 말씀드리겠소. \n꺾이지 않는 기세를 가진 적들과 마주치게 될 것이오. \n[적들의 경직 시간이 감소합니다.]");
		}
		else if (ranStage1 == 4) {
		...
		if (ranStage2 == 1) {
			talkq1[@0]	= new talkStruct("큰 길조로군. \n상처가 회복되는 행운을 누릴것이오. \n[적을 처치할 때마다 체력을 회복합니다.]");
		}
		else if (ranStage2 == 2) {
			talkq1[@0]	= new talkStruct("여행길에 길조가 있소. \n그대의 공격은 어느때보다도 맹렬하오. \n[모든 공격력이 50% 증가합니다.]");
		}
		else if (ranStage2 == 3) {
			talkq1[@0]	= new talkStruct("길조를 말씀드리겠소. \n그대의 공격이 적의 급소를 찌를 것이오. \n[모든 치명타 확률이 50% 증가합니다.]");
		}
		else if (ranStage2 == 4) {
			talkq1[@0]	= new talkStruct("여행길에 길조가 나왔소. \n재물복이 그대의 앞길에 놓여있소. \n[적을 처치하여 획득하는 재화가 2배 증가합니다.]");
		}
		
		talkq1[@1]	= new talkStruct(,,,1 , talkq1);
