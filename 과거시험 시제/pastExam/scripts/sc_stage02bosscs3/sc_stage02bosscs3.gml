...
function sc_stage02BossCs3(){
	...
	if (((isT == 4 || isT == 5 || isT == 6 || isT == 7) && active == true)) {
		...
		case 1:
			var name = "성춘향"
			var text = "아이의 부탁대로, \n납치된 사람들을 전부 구했네요!";
			sc_csBase(name, sp_chun_face_laugh, text, 1500, iy);
			break;
			
		case 2:
			var name = "성춘향"
			var text = "그럼, 다시 여행길에 올라볼까요? \n한양까지 아직 갈 길이 멀어요!";
			sc_csBase(name, sp_chun_face_smile, text, 1500, iy);
			break;
		...
		case 8:
			...
			sc_csBase(name, sp_st02Cs_kim_face, text, 1500, iy);
			break;
		...
		case 17:
			...
			sc_csBase(name, sp_reaper_face, text, 1500, iy);
			break;
