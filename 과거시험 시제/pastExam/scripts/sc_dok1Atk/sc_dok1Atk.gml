...
function sc_dok1Atk(){
	...
	if ( state == 11 ){
		...
		else if ( process < 35+lvDly ) { image_index = 2; xSpeed = dir*24; }
		else if ( process < 41+lvDly ) { image_index = 3; }
		else if ( process < 47+lvDly ) { image_index = 4; }
		else if ( process < 53+lvDly ) { image_index = 5; }
