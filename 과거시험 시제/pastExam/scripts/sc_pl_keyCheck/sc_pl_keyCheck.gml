function sc_pl_keyCheck() {
	...
	if ( sc_getKey(global.btLeft, global.gpLeft, 1) || axisH < -0.4 )		
		{ keyLeft	= true; }
	if ( sc_getKey(global.btRight, global.gpRight, 1) || axisH > 0.4 )		
		{ keyRight	= true; }
	if ( sc_getKey(global.btDown, global.gpDown, 1) || axisV > 0.4 )		
		{ keyDown	= true; }
	if ( sc_getKey(global.btUp, global.gpUp, 1) || axisV < -0.4 )			
		{ keyTop	= true; }
		
	if ( sc_getKey(global.btJump, global.gpJump, 1) )	{ keyJump2	= true; }
	if ( sc_getKey(global.btJump, global.gpJump, 0) )	{ keyJump	= true; }
	if ( sc_getKey(global.btAtk, global.gpAtk, 0) )		{ keyAttack = true; }
	if ( sc_getKey(global.btAtk, global.gpAtk, 1) )		{ keyAttack2 = true; }
